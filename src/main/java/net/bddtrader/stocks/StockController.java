...
public class StockController {
    ...
    @Operation(summary = "Find the latest price of a given stock")
    ...
    @Operation(summary = "Find the company details of a given stock")
    ...
    @Operation(summary = "Find the latest trades for a given stock")
    ...
    @Operation(summary = "Update the price of a given stock")
