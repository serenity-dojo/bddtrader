...
import net.bddtrader.acceptancetests.screenplay.tasks.ViewNewsAbout;
...
public class MarketNewsStepDefinitions {
    ...
    @When("^(.*) views information about (.*)")
    public void view_company_info(String traderName, String share) throws Exception {
        theTrader.attemptsTo(
                ViewNewsAbout.theShare(share)
        );
    }
